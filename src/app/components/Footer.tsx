            ...
            <div className="max-w-7xl mx-auto px-6 pt-20 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        <Link href="/" className="flex items-center gap-2 group w-fit">
                            <div className="bg-teal-500 p-1.5 rounded-lg group-hover:rotate-6 transition-transform">
                        ...
                        <p className="text-sm leading-relaxed text-slate-400 max-w-xs">
                            Providing compassionate, verified, and professional caregiving services.
                            We bring peace of mind directly to your doorstep in Bangladesh.
                        </p>
                        <div className="flex gap-4">
                            {/* <SocialIcon icon={<FaFacebook size={18} />} /> */}
                            <SocialIcon href='https://x.com/AbdulA48036' icon={<FaTwitter size={18} />} />
                            {/* <SocialIcon icon={<FaInstagram size={18} />} /> */}
                            <SocialIcon href='https://www.linkedin.com/in/abdul-rehman-aarmaan/' icon={<FaLinkedin size={18} />} />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm font-medium">
                            ...
                            <li><Link href="/caretakers">Find Caretakers</Link></li>
                            <li><Link href="/about">About Our Mission</Link></li>
                            <li><Link href="/careers">Join as a Caregiver</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li className="flex items-center gap-3 group">
                                ...
                                <Link href="tel:+8801725348534" className="text-slate-400">+880 1725 348534</Link>
                            </li>
                            <li className="flex items-center gap-3 group">
                                <Mail size={18} className="text-teal-500 shrink-0 group-hover:scale-110 transition-transform" />
                                <Link href='mailto:abdulrehmanaarmaan@gmail.com' className="text-slate-400">support@carenest.com</Link>
                            </li>
                        </ul>
                    </div>
                    {/* Column 4: Newsletter */}
                    <div>
                        ...
                        <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-teal-500/50 transition-all placeholder:text-slate-500"
                            />
                            <button className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 rounded-xl text-sm transition-all active:scale-[0.98] shadow-lg shadow-teal-900/40">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="mt-20 pt-8 border-t border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500">
                    ...
                    <div className="flex gap-8 font-medium">
                        ...
                        <Link href="/cookies" className="hover:text-teal-500 transition">Cookie Settings</Link>
                    </div>
                </div>
            </div>
        </footer>
...
const SocialIcon = ({ icon, href }) => (
    <Link href={href} className="w-9 h-9 flex items-center justify-center rounded-lg bg-slate-800 text-slate-400 hover:bg-teal-600 hover:text-white transition-all duration-300">
        {icon}
    </Link>
);
